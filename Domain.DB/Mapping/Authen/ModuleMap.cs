...
namespace Domain.DB.Mapping.Authen
{
	...
	partial class ModuleMap
    {
        ...
        partial void ModuleMapAppend()
        {
            ...
            this.Property(t => t.Sys_Gid).HasColumnName("Sys_Gid");
            ...
            this.HasRequired(t => t.System).WithMany(d => d.Module).HasForeignKey(f => f.SystemID).WillCascadeOnDelete(true);
        }
    }
}
