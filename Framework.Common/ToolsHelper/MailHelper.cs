...
// ***********************************************************************
// <copyright file="MailHelper.cs" company="湖南明创信息系统集成有限公司">
//     Copyright ©  2018
// </copyright>
...
namespace Framework.Common.ToolsHelper
{
    ...
    public class MailHelper
    {
        ...
        /// 邮件服务器地址
        /// </summary>
        private static string MailServer = Configs.GetValue("MailHost");
        /// <summary>
        /// 用户名
        /// </summary>
        private static string MailUserName = Configs.GetValue("MailUserName");
        /// <summary>
        /// 密码
        /// </summary>
        private static string MailPassword = Configs.GetValue("MailPassword");
        /// <summary>
        /// 名称
        /// </summary>
        private static string MailName = Configs.GetValue("MailName");
        /// <summary>
        /// 同步发送邮件
        /// </summary>
