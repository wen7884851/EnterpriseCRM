...
namespace Core.Tool
{
    public class MyServicesProxy
    {
        ...
        public static object InvokeWebService(string url, string methodname, object[] args)
        {
            ...
            try
            {
                //获取WSDLhttp://192.168.1.102:8080/BSTService.asmx
        ...
        /// <returns></returns>
        public static object InvokeWebService(string url, string methodname, object[] args, params Type[] types)
        {
            //这里的namespace是需引用的webservices的命名空间，在这里是写死的，大家可以加一个参数从外面传进来。
            string @namespace = "client";
            try
